...
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($c, $d, true, ['json' => false, 'xml' => false, 'html' => true], 'json'));
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($c, $d, true, ['json' => false, 'xml' => false, 'html' => true], 'json'));
$b->addLoader($f);
